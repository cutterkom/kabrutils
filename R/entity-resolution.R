...
#'
#' @param data data as a document frequency matrix `dfm()` with a set `doc_id`
#' @param method character; the method identifying the similarity or distance measure to be used, see `?quanteda::textstat_simil`
#' @param min_sim numeric; a threshold for the similarity values below which similarity values will not be returned; 0.75-0.8 seems reasonable
#' @export
